...
public class GUI implements ActionListener {
    ...
    JScrollPane scrollPane; //Add Scrollbar when we enter beyond text area
    ...
    File fun = new File(String.valueOf(this));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(command){
            ...
            case "size28"        : format.createFont(28);
                break;
            case "White", "Blue", "Black": col.changeColour(command);
                break;
            case "Copy to Stack", "Copy (Ctrl + C)", "Cut to Stack", "Cut (Ctrl + X)", "Paste from Stack",
                 "Paste (Ctrl + V)", "Time & Date":  edit.editText(command);
                break;
        }
    }
    ...
    public void createWindow(){
        window = new JFrame("Written Area");
